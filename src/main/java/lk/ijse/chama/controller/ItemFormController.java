...
import lk.ijse.chama.bo.custom.PlaceItemBO;
...
public class ItemFormController {
    ...
    public void txtitemIdOnKeyRelese(KeyEvent keyEvent) {
        Regex.setTextColor(lk.ijse.chama.util.validation.TextField.IID,txtItemId);
    }

    public void txtQtyOnKeyRelesed(KeyEvent keyEvent) {
        Regex.setTextColor(lk.ijse.chama.util.validation.TextField.QTY,txtQty);
    }

    public void txtUnitPriceOnKeyRelesed(KeyEvent keyEvent) {
        Regex.setTextColor(lk.ijse.chama.util.validation.TextField.PRICE,txtUnitPrice);
    }
