...
public class EmployeeFormController {
    ...
    public void txtEmpIdOnKeyRelesed(KeyEvent keyEvent) {
        Regex.setTextColor(lk.ijse.chama.util.validation.TextField.EID,txtId);
    }
    ...
    public void txtSalOnKeyRelesed(KeyEvent keyEvent) {
        Regex.setTextColor(lk.ijse.chama.util.validation.TextField.PRICE,txtSallary);
    }

    public boolean isValidate(){
        if(!Regex.setTextColor(lk.ijse.chama.util.validation.TextField.EID,txtId))return false;
        ...
        if(!Regex.setTextColor(lk.ijse.chama.util.validation.TextField.PRICE,txtSallary))return false;
